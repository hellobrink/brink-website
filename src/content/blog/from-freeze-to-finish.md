...
heroAlt: From freeze to finish
bannerImage: "/images/66d9b361ba7e12017c60cf47_0_mpkna0jbqr03j_4z.webp"
bannerAlt: From freeze to finish
summary: Do you remember how you felt in March 2020 — the month the UK went into a national lockdown? The month when the words “global pandemic” really hit home?
sortOrder: 87
---
...
But I was also incredibly lucky to be part of a team funded by UK Aid who within 24 hours of the WHO’s announcement of a global pandemic, launched [COVIDaction](https://medium.com/covidaction/what-is-covidaction-2605efa4803a?ref=hellobrink.co): an initiative to source and scale innovations from across the globe responding to the pandemic. By offering funding and venture support to make them happen, we brought together a team of multidisciplinary experts who hoped to uncover the next generation of innovations to solve the pandemic and other global challenges across four thematic areas: local production and solutions, data, resilient health systems, and global access to oxygen.
...
![](/images/66d9b33af7cd6d8ec000dd20_0forxw0zmygoru4qi.png)
...
- Applying networked learning to inform the next generation of oxygen concentrators for low-resource settings, engaging with 100+ experts through a [global series of meetups and interviews;](https://medium.com/covidaction/the-oxygen-colab-meet-up-on-growth-impact-and-value-aef02d2be58f?ref=hellobrink.co)
- Supporting our innovator from Nepal to build a [web of production](https://makerko.com/?ref=hellobrink.co) to have better insight into existing PPE demand and production capacity;
- [Bringing together communities of local producers](https://afrilabs.com/afrilabs-and-covidaction-to-support-offline-community-ventures-in-kenya-nigeria-and-uganda/?ref=hellobrink.co) not connected to the internet to learn from each other.
...
SIGNALS OF A WORLD WHERE OXYGEN IS AVAILABLE TO ALL

## 4. Really listen

We’ve built the networks, but then we also listened closely to what was emerging from the work of our partners and collaborators. We then moved resources around based on their feedback and requests for support. For example, many of our [data innovators](https://medium.com/covidaction/building-a-healthy-data-ecosystem-to-fight-covid-19-or-doingdataright-ed0305bd1313?source=collection_category---4------1-----------------------) pivoted to respond to the emerging needs of the pandemic, such as the equitable distribution of vaccines. We’ve followed them on their journey, and changed our focus to exploring [how data might be used for the equitable distribution of vaccines?](https://medium.com/covidaction/apply-now-open-call-announcement-of-the-vaccine-data-co-lab-6f0a4e367066?ref=hellobrink.co)
...
During COVIDaction Brink created an intentional simple framework to give us the handrails to help us answer those big questions. We called it [SETS](https://medium.com/covidaction/covidaction-building-a-technology-and-innovation-pipeline-to-support-the-pandemic-response-24d1ec8aeb86?ref=hellobrink.co). We set out to **S**can the globe for promising innovation, **E**valuate what we find, **T**eam up with experts for venture support, and**S**hare what we find as a global good. We’ve brought world-class experts to lead each area, but made sure to use the SETS framework as a guide, not dogma, with space to dial elements up or down depending on what experts believed was suited to each — vastly different — area.
...
Once the entire team embodied this framework, it helped us ensure our networks could also leverage it to continue to answer our shared big questions, beyond our direct support. For example, we partnered with pan-African organisation [AfriLabs](https://afrilabs.com/afrilabs-and-covidaction-to-support-offline-community-ventures-in-kenya-nigeria-and-uganda/?ref=hellobrink.co) to lead [a local innovation scouting](https://medium.com/covidaction/get-your-feet-on-the-ground-insights-from-scouting-local-innovations-47ae7eb39f0f?source=collection_category---4------2-----------------------) process. We wanted to explore together the **big question** [‘How do you connect global resources to local communities to support recovery in a time of crisis?’](https://medium.com/covidaction/afrilabs-scouts-engage-grassroots-communities-for-impact-in-africa-e5472bb96e70?source=collection_category---4------4-----------------------)
...
![](/images/66d9b33af5e5618aed89ed11_0ibb7kihrkdx6cvia.png)
...
**To find out more about**[**COVIDaction**](https://twitter.com/COVIDactionTech?ref=hellobrink.co)**, follow them on**[**Twitter**](https://twitter.com/COVIDactionTech?ref=hellobrink.co)**or read their**[**blog**](https://medium.com/covidaction/explainer/home?ref=hellobrink.co)**.**
