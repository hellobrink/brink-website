...
bannerAlt: "Innovating internal comms at Brink: getting started"
summary: Last year, Brink celebrated turning 5. In the year that welaunched a Foundation, wrapped up projects, started new ones, and had a ton of new Brinksters join us, we also redefined our business strategy and explored where we want to take Brink in the next 5 years. As we develop and
sortOrder: 64
---

*Last year, Brink celebrated turning 5. In the year that we*[*launched a Foundation*](https://hellobrink.co/introducingbrinkfoundation/)*, wrapped up projects, started new ones, and had a ton of new Brinksters join us, we also redefined our business strategy and explored where we want to take Brink in the next 5 years. As we develop and expand, we’ve recognised we need to evolve the structures we rely on to communicate with each other - keeping us, us.*

*This is the first part in a series of blogs about our internal communications journey. In this blog, we’ll share our thinking behind the project we set ourselves, what we did to get started, and touch on some of the key findings we discovered. You can read part two*[*here*](https://hellobrink.co/innovating-internal-comms-at-brink-testing-and-learning-towards-positive-change/)*.*
...
As a remote-first organisation with a [model for global business](https://hellobrink.co/being-global/), we’ve done a lot of work to make Brink a place where people can do their best, and feel healthy and well. This includes making a [Mental Health at Work commitment](https://hellobrink.co/mental-health-awareness-week-making-a-commitment/) and regularly exploring how we can look after Brinksters’ [wellbeing](https://hellobrink.co/world-wellbeing-week-2023/) while navigating an ever-changing world of challenges and opportunities.
...
We’ve always strived to have clarity, honesty and a human-centred approach in how we communicate, from how we use Slack and the way our internal Notion pages work, to our tone of voice in the likes of our hiring rallies. We’re proud to be a [B Corp](https://www.bcorporation.net/en-us/find-a-b-corp/company/brink/?ref=hellobrink.co), and one of [Escape The City’s top 100](https://hellobrink.co/esc2023/) places to escape to, so it’s important to us that we prioritise the kinds of things that foster a culture that works for, and supports everyone.
...
**You can read part two**[**here**](https://hellobrink.co/innovating-internal-comms-at-brink-testing-and-learning-towards-positive-change/)**.**
...
*We’d love to chat****matthew@hellobrink.co***
