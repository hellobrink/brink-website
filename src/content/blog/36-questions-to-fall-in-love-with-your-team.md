...
heroAlt: "36 questions to fall in love with your team"
bannerImage: "/images/66d9cb6123e4687cc530cbf9_advice-to-our-15-year-old-selves.webp"
bannerAlt: "36 questions to fall in love with your team"
summary: "People often ask me: ‘how can we run more productive team meetings?’ My reply? It depends on your objective, of course. But it also depends on what you mean by productive, and that’s where things get particularly interesting. If, by productive, you mean burning through a to-do li"
sortOrder: 73
---

**People often ask me: ‘how can we run more productive team meetings?’ My reply? It depends on your objective, of course.** But it also depends on what you mean by productive, and that’s where things get particularly interesting. If, by productive, you mean burning through a to-do list, divvying up tasks or creating work together there are meeting formats like kanbans, standups, ceremonies and [Amazon-style no Powerpoint memo meetings](https://www.inc.com/carmine-gallo/jeff-bezos-bans-powerpoint-in-meetings-his-replacement-is-brilliant.html?ref=hellobrink.co). In some cases it’s more productive to cancel the meeting entirely, especially given [most of us are now spending 85% of our work week in meetings](https://hbr.org/2021/09/collaboration-overload-is-sinking-productivity.?ref=hellobrink.co).

But there’s a different kind of productive which calls for a different kind of meeting, especially now so many of us are finding ourselves on remote or hybrid teams when we didn’t first set out that way. Productive can also mean building deeper relationships and trust. The kind of connections that pay dividends when you need to get into production mode. These are the connections that help us jam in our work by creating a foundation of truth and safety between our team members, which is the [number one predictor of high performing teams](https://medium.com/hellobrink-co/tips-for-creating-psychological-safety-e1fe4a2bcfa5?ref=hellobrink.co).
...
## For inspiration on rituals and tempos at work, I often turn to First Round, Bracket, Atlassian, and chat with other founders on how they approach this. A bit further afield I turn to psychology, and as it turns out, relationship advice from the likes of the mighty Esther Perel or Arthur Aaron on how to fall in love 😘
