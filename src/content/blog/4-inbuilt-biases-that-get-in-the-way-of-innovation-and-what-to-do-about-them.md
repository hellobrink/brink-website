...
heroAlt: "4 inbuilt biases that get in the way of innovation, and what to do about them"
bannerImage: "/images/66d9c6de769448a365bee58b_0_cnljzatrirraodhc.webp"
bannerAlt: "4 inbuilt biases that get in the way of innovation, and what to do about them"
summary: ABI FREEMAN
sortOrder: 79
---

[ABI FREEMAN](https://hellobrink.co/team/abi/)

30 APR 2022

**In our work as Behavioural Innovation practitioners, we have witnessed innovation evolve into a science with its own dedicated academic papers. It's now an established industry in its own right projected to be**[**worth $3.69 billion by 2032.**](https://www.polarismarketresearch.com/industry-analysis/innovation-management-market?ref=hellobrink.co#:~:text=Innovation%20Management%20Market%20size%20was,10.6%25%20during%20the%20forecast%20period.)

Decades of working with corporates, governments and startups, have shown us that typically teams take the approach that '*If I do X in this way, innovation will follow'*. But the truth is that innovation is much more complicated than that.

Innovation is hard because it is not linear. It’s affected by the world around it, it happens in complex systems, and it’s all done by humans who are, by our very nature, irrational, imperfect and emotional beings.

Have you ever eaten a particular food even though you know it’s bad for you? Of course you have. Even though the rational part of brain knows it probably shouldn't, you are readily able to override logic and reason, especially when there is a delicious [insert your favourite food here 🤤] in front of you.

**We are all predictably irrational.**

Innovation requires us to try many, many ideas that aren’t going to work before we hit on one that does ([evidence shows us that the quantity of ideas](https://www.frontiersin.org/articles/10.3389/fpsyg.2015.00864/full?ref=hellobrink.co)is directly linked to eventual quality of outcome). But even though we know failure is a core part of innovation, the reality is simple: failure is tough.
...
And we definitely don’t talk enough about how the person’s willingness and ability to ‘break things’ is often predicated on safety nets, fallback plans and privilege (as theis perfectly-placed Post-it on a wall at Meta's office demonstrates):

![](/images/66d9c6bd1c2ccb3479de542c_0_cnljzatrirraodhc-1.webp)

We also forget that human behaviour is impacted by context. We can shape behaviours by shaping the context or environment. The way that chocolates used to be positioned in supermarket checkouts was not accidental — up to 80% of our purchases are impulse buys. We suddenly crave what’s put in front of us even when it wasn’t even on our shopping list.

Our behaviour is shaped by the layout of our environment. If we want people to be creative and innovative, to generate volumes of ideas and test them in the real world, we must be mindful of the context and environment they are operating in.

When we think about how innovation happens, this recipe of beautifully imperfect humans being impacted by their context means that, if we’re not shaping the context to be favourable to innovation, we are not setting up our efforts to innovate for success.

*In this piece, we’ll walk you through four things that the predictably irrational brain does, and how those things create natural barriers to innovation. We’ll share some ways that, as Behavioural Innovation practitioners, we can think about designing organisations, teams, methods, contexts to overcome or foster the behaviours we want to see.*
...
But, as the global pandemic demonstrated, the future is not linear. Nor do we want it to be; because linear progress isn’t enough to cause the radical social change we need. At this rate, we won’t have every child into school and learning before 2080 unless we bend the curve of progress. And don’t get me started on the trajectory of the climate crisis…

Present bias is why we need deliberate invention to accelerate progress.

To overcome present bias at Brink, we think about creating conditions that allow us to entertain other ways of thinking, bigger and bolder visions of the future. We also consider how to take a portfolio approach to innovation that allows us to carve out time and resources to deliberately step out of the present, into inventing for the future we want.

Here are a few of the ways we achieve this:

## Golden ratio

We are deliberate about how we use our time and resources for business as usual vs innovation, so that we can snap out of incremental gains. [Inspired by Harvard’s golden ratio](https://hbr.org/2012/05/managing-your-innovation-portfolio?ref=hellobrink.co), we divide our time and resources using the 70/20/10 ratio. 70% of our work is about existing propositions, 20% is about incremental and adjacent shifts to the work, and 10% is about bigger bets for the future. The 10% is high risk, high reward and ideally will become our future 70%. This golden ratio moves away from assuming that our work today will still be relevant tomorrow.

## Psychological safety

We know that thinking about the future in this speculative way is not always comfortable, so we intentionally create [psychological safety](https://medium.com/hellobrink-co/tips-for-creating-psychological-safety-e1fe4a2bcfa5?ref=hellobrink.co) by de-risking ‘being wrong’. Really, what’s the worst thing that can happen if your 10% about the future is wrong?
...
![](/images/66d9c6c02c8fe55e967ef841_0zjysm_q36j4kchdn.jpeg)
...
So when it comes to innovation, while it’s important to create permission within teams and organisations to innovate and change the status quo, it’s not enough. Instead, we need to make it the default that we’ll continually look to the future and plan for it.

These are some of the ways we generate ideas and test them objectively and systematically:
...
Famously, in 2008, Netflix pitched to sell to Blockbuster, but because the idea didn’t come from inside the company, Blockbuster rejected the proposal. Two years later, Blockbuster filed for bankruptcy and Netflix has a market cap of $288.28 Billion (as of June 2024).
...
In a famous psychology experiment that has been replicated the world over, children are given the option of having one marshmallow now, versus two in 15 minutes.[In a very endearing set of studies](https://www.youtube.com/watch?v=G7TcYs0cGt4&list=PL2etPlnTb9sWGw-Fp0EdksmWkGEcy22-t&index=4&ref=hellobrink.co), the children find it incredibly hard to wait, even though the payoff will be bigger. The majority eat the marshmallow now, they can’t wait for two.
...
*Our colleague Emma Proud wrote recently about*[*Your Brain on Innovation*](https://medium.com/hellobrink-co/your-brain-on-innovation-40a8770895aa?ref=hellobrink.co)*from the individual’s perspective and how to optimise innovation efforts. We have taken a more organisational approach, here. We’re also mulling on what’s different for innovating in complex systems. Watch this space 👀*
