...
heroAlt: "Venturing: How we work with funds, portfolios, and ideas to make a dent in the world"
bannerImage: "/images/66d9cbe09b3ad9c951ffc290_asad-blog.webp"
bannerAlt: "Venturing: How we work with funds, portfolios, and ideas to make a dent in the world"
summary: At Brink, we work with the building blocks of change and impact. Stories. Teams. Organisations. Collectives. Ideas. Money.
sortOrder: 72
---
...
For centuries, but especially *this*century, we’ve seen how scaling ideas and directing funding flows have shaped our world. How would things be different if Facebook hadn’t grown to two billion users? Do we want a world in which Theranos — the fraudulent Silicon Valley blood testing startup — can raise [$1.4bn](https://www.crunchbase.com/organization/theranos?ref=hellobrink.co), 82 times the equity investment in every company in Rwanda put together ([$17m in 2021](https://partechpartners.com/download-paf2021-pdf/?ref=hellobrink.co))? Where would we be if the US government hadn’t invested in DARPA, the “[agency that shaped the modern world](https://www.economist.com/science-and-technology/2021/06/03/a-growing-number-of-governments-hope-to-clone-americas-darpa?ref=hellobrink.co)”, by funding and inventing precursors to the internet, GPS, and drones?
...
There’s [lots](https://www.bethnalgreenventures.com/?ref=hellobrink.co) [of](https://bfaglobal.com/?ref=hellobrink.co) [organisations](https://www.secondmuse.com/capital/?ref=hellobrink.co) we admire doing similar work. So, why do we think it’s important for Brink to have a venturing practice?
...
Understanding the biases, motivations, emotions, cultures and other factors at play in people is how we work, in our venturing practice and at Brink as a whole. We call this [behavioural innovation](https://medium.com/hellobrink-co/behavioural-innovation-embracing-behavioural-science-for-lasting-impact-85d1d78688f4?ref=hellobrink.co), and it powers everything we do. In a nutshell: it’s innovation + people.

**Let’s dive into what that means in the real world.**

## Building a fund to give children access to oxygen

**Every year,**[**4.2 million children**](https://www.unicef.org/press-releases/severe-pneumonia-leaves-42-million-children-desperate-oxygen-each-year?ref=hellobrink.co)**with severe pneumonia in low and middle-income countries (LMICs) need oxygen to survive.**

Working with IMC Worldwide and with funding from the UK Foreign, Commonwealth & Development Office (FCDO), we’re designing a fund to answer this entrenched problem. It’s called the [Oxygen CoLab](https://medium.com/covidaction/oxygen/home?ref=hellobrink.co), set up to improve access to medical oxygen.
...
The Oxygen CoLab worked with UNICEF, local communities, NGOs, academic institutions, manufacturers, and engineers. Together, this partnershsip accelerated the pace towards a [Target Product Profile](https://www.unicef.org/supply/stories/unicef-drive-development-robust-concentrator-support-oxygen-colab-and-uk-government?ref=hellobrink.co), a set of requirements for oxygen concentrators.
...
Brink is the Innovation partner on the [EdTech Hub](https://edtechhub.org/?ref=hellobrink.co), partnering with Results for Developoment, Jigsaw, Open DevEd, and others. A big part of our work is to design and manage [Sandboxes](https://edtechhub.org/sandboxes/?ref=hellobrink.co) to try and scale impactful edtech ideas.
...
Global Disability Innovation (GDI) Hub, BFA Global and Brink founded the [Assistive Tech Impact Fund](https://www.atimpactfund.com/?ref=hellobrink.co) in response to these challenges. It provides funding of between £100–300k and 6 months of venture building support to assistive tech ideas. Our focus is ideas that have achieved product-market fit and are looking to sustainable scale.
...
Rwanda is experiencing a boom in tech investment, yet only 8.4% of its population can use a computer ([according to the World Bank](https://documents1.worldbank.org/curated/en/912581580156139783/pdf/Rwanda-Economic-Update-Accelerating-Digital-Transformation-in-Rwanda.pdf?ref=hellobrink.co)). How might we build the digital skills of those currently excluded from the benefits of tech?
...
**In partnership with the Wellcome Trust, we’ve created the**[**Well_Lab**](https://www.well-lab.co.uk/?ref=hellobrink.co)**.**
...
In particular, we want to use a business-led approach to get evidence into the hands of business leaders, to help them take better care of their people. We talk about [business resilience (not staff wellbeing)](https://www.well-lab.co.uk/articles/business-resilience-44dwc?ref=hellobrink.co). And we get research funded by Wellcome Trust on wellbeing off the page, and into the real world. Getting away from ‘quick fixes’ and perks towards ideas that *actually*make a difference.
...
**If you want to chat about our practice, drop me a line on**[**asad@hellobrink.co**](mailto:asad@hellobrink.co)**.**
