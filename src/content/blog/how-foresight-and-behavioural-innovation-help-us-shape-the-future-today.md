...
bannerImage: "/images/67e2c4892b464a0b4bf20640_conference.jpeg"
bannerAlt: "The Future Starts Now: How foresight and behavioural innovation help us shape the future today"
...
## **What we did:** **Immersive experiences & Artefacts from the future**

![](/images/67e29eabaecfe85cf2b110b7_ad_4nxcacqhks1bgdszoqibcamvwz1ph3m9lohgy-4xnuzpfdias2ph.png)

As part of our role on the [Frontier Tech Hub](https://www.frontiertechhub.org/) we work with UK Foreign, Commonwealth and Development Office (FCDO) staff and global partners to understand the potential for innovative tech to address global challenges, and then test and scale their ideas.

To tackle the question of ***How might AI might change diplomacy in the next 10 years?*** we tookpolicy advisers on a 60-minute [Fieldtrip to the Future](https://www.frontiertechhub.org/fttf-ai-and-diplomacy) to the year 2034, where they navigated two distinct AI-driven diplomatic scenarios in [trade & economy](https://www.frontiertechhub.org/trade-and-economy-scenario) and [human rights](https://www.frontiertechhub.org/human-rights-scenario) and experienced new ways of working with coworkers like [diplobot](https://www.frontiertechhub.org/human-rights-scenario).
...
Each year, GIZ runs a Future Forum for their keenest staff passionate about creating a more just and equitable world using strategic foresight methods. We were fortunate to be invited to kick off [GIZ](https://www.giz.de/en/html/index.html)’s [Future Forum 2023](https://www.giz.de/expertise/html/63409.html) with 460 participants from 67 countries, with visioning workshops to explore ***How we navigate the polycrisis and drive transformative change to ensure a healthy Earth for all within planetary limits?***Resulting in transformative visions for agriculture & food systems, energy, transport & mobility, and resources & circularity. We pushed participants to [imagine bold, socially empowered futures](https://www.youtube.com/watch?v=f09N3npc4DU), rather than just predicting what’s likely. We designed a Vision Compass and Postcards From the Future to guide them in shaping a 2050 world driven by big, systemic changes, without prescribing local solutions.
...
At Brink, we worked with [TRANSFORM](https://www.transform.global/news/research-the-future-of-work/) (a partnership between FCDO, EY, and Unilever) to explore ***What the future of work could look like for the 83% of Kenyans working in the informal economy****.*
...
Another cognitive gap arises round representation and resonance. AI is mostly [built on flawed and biased datasets](https://www.linkedin.com/pulse/were-building-ai-flawed-flaky-past-heres-why-what-we-must-freeman) and LLMs have been known to draw on mis/disinformation rather than truth and facts It is therefore not always a fair representation of truth nor of a vast proportion of the world’s population. Unaddressed, this compounds biases and widens digital divides.
...
## **What we did:** **AI and technology as a creative partner with humans in the lead**

![](/images/67e2c3de1e99c1813cab2771_priya.jpg)
...
*If you’re ready to explore how foresight and behavioural innovation can drive transformative change within your organisation or sector, we’d love to connect. Reach out to Gita at*[*gita@hellobrink.co*](mailto:gita@hellobrink.com)*to learn more about how we can collaborate and build a better future together.*
