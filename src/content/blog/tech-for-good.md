...
heroAlt: Tech for good? Lessons from 6 years of grappling with tech to make the world a better place
bannerImage: "/images/67adb93f997fa982da132034_screenshot-2025-02-13-at-091911.png"
bannerAlt: Tech for good? Lessons from 6 years of grappling with tech to make the world a better place
summary: I’ve spent the last 6 years of my working life obsessed with one question.
sortOrder: 21
---
...
*A few months ago, I delivered a lecture to 30 Masters’ students at University College London - my old university. The lecture became a synthesis of everything I’ve learnt about this question. A huge thanks to*[*Alex*](https://www.designswarm.com/)*and*[*Duncan*](https://www.iot.io/)*for the opportunity!*

*With minor edits, this piece puts those spoken words on paper (thanks to*[*Jason*](https://uk.linkedin.com/in/jasonvunguyen)*for looking at a draft of this).*
...
Fast forward to the last few years, and we’ve had a global shift in how people think about tech. Social media makes us angry and [hateful](https://phys.org/news/2023-04-analysis-speech-significantly-twitter.html). Internet-enabled businesses like AirBnB and Uber erode communities1. Big tech avoids tax, invades our privacy, and manipulates our behaviour.
...
- What does it *actually* meanto “make the world a better place”?
- Practically speaking, how can we fund and scale the tech ideas that might do that?
- Is the tech you’ve built *really* making people and communities better off in the long run?

The last six years at [Brink](https://www.linkedin.com/company/hellobrink/) have given me the privilege to act as grantmaker, coach, and strategist to amazing tech entrepreneurs and funders all over the world. Much of this piece draws from that well of experience, as well as my writing and thinking.
...
A few years ago, I worked with a Rwandese startup called [Ampersand](https://www.ampersand.solar/)2 through the [Frontier Technologies Hub](https://www.frontiertechhub.org/)3. Ampersand’s mission is to build and scale electric motorbike taxis in Rwanda, and then across sub-Saharan Africa.

![](/images/6797880998248db8e795851a_1737458477670.jpeg)
...
I’ve had the privilege to design and manage programmes and funds aimed at giving people agency. For instance, [EdTech Hub](https://edtechhub.org/)7 was founded in response to the fact that 70% of children in the world, at age 10, can’t read and understand a simple sentence. It funds research and seeks to scale tech products to tackle this problem. The [Assistive Tech Impact Fund](https://www.atimpactfund.com/about)8 is a grant-based scaling fund, founded because almost a *billion*people around the world need the use of assistive technology (such as eyeglasses, hearing aids, prosthetics, or wheelchairs), and 80% don’t have it.
...
## Practically speaking, how might we fund and scale tech ideas that build agency?
...
![](/images/67978809123138d316fa6b60_1737458617864.png)

Source: [Forbes](https://www.forbes.com/sites/sageworks/2016/10/23/navigating-the-make-or-break-years-as-you-create-hockey-stick-growth/)
...
## Enter the social unicorn and endgame theory

Last year, I had the privilege of designing and delivering the scaling strategy curriculum for the [100x Impact Accelerator](https://www.100ximpact.org/), run by the Marshall Institute at London School of Economics (LSE)9. 100x Impact’s mission is to nurture the next generation of *social*unicorns. These are startups that can tackle the world’s most pressing challenges in health, climate, and education on the *scale of billions*.
...
I first came across [Gugelev & Stern's 'endgames' concept](https://assets.globalgiving.org/social-impact-academy/whats_your_end_game.pdfhttps://assets.globalgiving.org/social-impact-academy/whats_your_end_game.pdf) on the 100x Impact Accelerator. Endgames are different routes to scale and impact for startups. Crucially, only one of these is “sustained service” - where the startup grows in size and directly provides a product and service to billions. Other endgames include:

- **Government adoption:** government takes on delivery of a product or service, reaching millions of citizens. German immigrants introduced kindergarteners to the US in the mid-19th century. They were first run by charities, before the government started to recognise the benefits of early childhood education and open public kindergartens in the late 19th and 20th century.
- **Commercial adoption:**other companies take what you do and adopt it in their markets. Safaricom’s M-Pesa, launched in Kenya in 2007, was the world’s first mobile money product. They proved mobile money was profitable, and other telecom companies adopted it in their countries. There are now 1.75bn mobile money users worldwide, [according to the GSMA](https://www.gsma.com/sotir/wp-content/uploads/2024/04/GSMA-SOTIR-2024_Report_Executive_Summary_v5-ENG.pdf).
- **Replication:** not-for-profits copy or franchise what you do for their communities. Since the 1990s, Marie Stopes International (MSI) has been offering training, follow up support, interest free loans, branding and equipment to clinics who want to deliver sexual and reproductive health services (in exchange for a fee). Hundreds of clinics worldwide pay to replicate MSI's model as a franchisee10.
- **Open sourcing:**anyone can access the product or service, at no/minimal cost. 120M learners watch [Khan Academy's](https://www.khanacademy.org/) free educational videos every year. The platform is funded by a mix of donations (78% of income in 2022-23) and premium content (22% of income)11.
- **Policy influencing:** an idea becomes national policy. Consistent research into the links between smoking and lung cancer, starting in the 1950s, led to a smoking ban in public places in the United Kingdom in 2007.
- **Societal and cultural change:** an idea becomes a part of ‘common sense’ mental models and behaviour. Harvard School for Public Health launched the "Designated Driver" campaign in 1988. Designated Drivers (responsible for driving others who have consumed alcohol) featured in various US TV shows, including “Dallas” and “Cheers”. The term entered Webster’s Dictionary in 1991. Between 1988-94, alcohol-related traffic deaths fell by 30%12.

I spent a lot of time talking about endgames with startups on the 100x Impact Accelerator. The big takeaway was: to build *agency*on the scale of billions, you don’t have to scale your own organisation. You can build a product, and others can deliver it or replicate it in their markets (like [M-PESA Africa](https://www.linkedin.com/company/m-pesa-africa/) or kindergartens). You can certify, lend expertise, train or partner with others (like [Marie Stopes International](https://www.linkedin.com/company/marie-stopes-international/)). You can have an idea, or some evidence, and reach people through advocacy, storytelling and influencing policy (like the Harvard School for Public Health).
...
I had the joy of working with an awesome duo in Zambia: [Wyson](https://www.linkedin.com/in/wyson-lungu-57b7b498/?originalSubdomain=zm), the Founder of Onyx Connect (a local startup) and [Steve](https://www.linkedin.com/in/steve-beel-ba36572/), a civil servant for the UK Foreign, Commonwealth & Development Office. Steve had the idea of ‘pay as you go’ bicycles to help rural farmers in Zambia make long journeys. Wyson brought it to life, providing rural farmers with a bike, solar lamp, feature phone and GPS tracking unit for $5-10 per month (over 12-36 months).
...
To date, Onyx Connect has sold 3,000 bikes. Their work has been featured on the [BBC](https://www.bbc.co.uk/programmes/p09f3dym) and [Guardian](https://www.theguardian.com/global-development/gallery/2020/jun/04/pedal-power-zambias-female-farmers-go-further-by-bike-in-pictures?page=with%3Aimg-7). There’s more demand for pay-as-you-go bikes than they can keep up with, so they’re looking for loans or grant funding to scale their operation.
...
![](/images/67978809901a5b426607556a_1737458765112.png)

A Koalaa prosthetic being fitted in Gaza

Not only did the [Assistive Tech Impact Fund](https://www.atimpactfund.com/) buy into this vision, but they also saw Koalaa’s potential for amputees in sub-Saharan Africa. At a cost to Koalaa of $75 per year (including ongoing care)14, prosthetic arms could be transformative for users, at low cost. The biggest game-changer was that anyone could be certified to fit someone with the prosthetic after one day of training.
...
We started by building an evidence base on how a VLE might work in Zanzibar. This included a [feasibility study](https://docs.edtechhub.org/lib/?all=zanzibar&page=1&page-len=1&id=K7JDL4IL) and guide to [VLE content curation](https://docs.edtechhub.org/lib/?all=zanzibar&page=3&page-len=1&id=T2W7MU3K). Using this evidence, we built a “paper prototype” - an A3 sheet showing a blueprint for how the VLE would function in practice providing education resources to teenagers. We took this to 1:1 interviews with 24 teachers. 90% of those teachers told us their biggest problem was actually the inadequacy of educational resources available to them (textbooks, lesson plans, etc).
...
We went back to our paper prototype, iterating it to focus on content that teachers could use as teaching aides with their students17. This content would be available offline and include guidance for teachers on when to use it. The World Bank and government took this basic blueprint, and embedded it in their [six year, $50M education spending plan](https://documents1.worldbank.org/curated/en/099145012052214156/pdf/BOSIB04b74cfa50200a65203306758e5773.pdf).
...
## Testing and validating whether a new idea will scale
...
‘Lean’ as a business term started in the manufacturing sector in Japan. Companies like Toyota adopted [lean manufacturing](https://en.wikipedia.org/wiki/Lean_manufacturing) to mean two things. First, identify what brings value to a customer. Then, deliver this value, with no waste, and continuous improvement of products.

Eric Reis adopted these same principles for the world of [startups](https://theleanstartup.com/principles), and later, large corporates. For Reis, startups should build the smallest possible version of their idea, test it with customers, learn, and iterate. Getting through these cycles quickly, for Reis, the *only* good use of a startup’s limited resources.

![](/images/6797880916cce9b64892585c_1737459019200.png)

Source:[Lean Startup Co](https://theleanstartup.com/principles)
...
- ***What do you believe?***These are important things you believe to be true for your idea to scale, but haven’t validated with data. Also known as a hunch, assumption, or gut feeling.
- ***How will you verify this?***This is something you can go out and do, to get data on that belief. It might be building a simple version of your idea, or speaking to some users, or running something for a month.
- ***What will signal that we’re on the right track?***Some indicator or piece of data that will tell us our belief is valid, for now.
...
[Ann Mei Chang](https://www.linkedin.com/in/annmei/), who has [adapted Eric Reis’ ‘lean startup’ for social impact](https://www.annmei.com/), adds one other type of uncertainty. That’s uncertainty about **impact**, or whether a product actually improves lives. Or, as I would put it, uncertainty about whether the product helps people to shape the life they want.
...
Let’s bring this together with one final example. During my time on the [Frontier Tech Hub](https://www.linkedin.com/company/frontier-tech-hub/), [Antony H.](https://www.linkedin.com/in/antony-h-73554537/) - a civil servant and true intrapreneur - approached us with the idea of using ‘smart’ (internet connected) vending machines to distribute contraception in Kenya.
...
## Testing and validating at the level of a portfolio
...
## The real work: understanding what makes people and systems tick

I come back to core concepts like agency, scaling, endgames, and experimentation a lot. But the school of thought I’ve come back to most in the last five years is [Organisation & Relationship Systems Coaching](https://www.crruk.com/) (ORSC).
...
Building on ideas such as ORSC, we’ve developed [behavioural innovation](https://bi.hellobrink.co/) at Brink. Behavioural innovation is our proven method, combining innovation methods with insights from the behavioural sciences on incentives, psychology, and change.
...
- **Sunk cost fallacy:**the tendency to keep on a certain path, because we’ve already invested in it.
- **HIPPO effect:**a situation where the most senior person’s opinion carries most weight, regardless of evidence, or their closeness to the detail.
- **Confirmation bias:** seeking out evidence that validates existing beliefs, and ignoring contradictory signals.
...
Between 2019-20, Frontier Tech Hub and UNICEF collaborated to fund [Swoop Aero](https://swoop.aero/), an Australian drone startup, in Malawi. Our goal was to test [whether multi-purpose drone operations](https://medium.com/frontier-technologies-hub/multi-purpose-drone-operation-in-malawi-b4cf671b14d1) were cost-effective and viable in rural Malawi.
...
[Marie-Claude](https://www.linkedin.com/in/mcvillacorta/), our partner from UNICEF, and [Martyn](https://www.linkedin.com/in/martyn-carroll/), who led African operations for Swoop Aero, recognised these disruptions. They responded by holding our work accountable to a key metric: the number of Malawians trained as drone pilots or operators24. Swoop Aero would provide the cutting edge tech; Malawians would shape its arc in their own country.
...
![](/images/6797880938408957366f159c_1737459781186.png)

Concept drawing for the smart contraceptive vending machine
...
Catalytic philanthropy, [coined by Bill Gates](https://www.gatesnotes.com/The-Power-of-Catalytic-Philanthropy) (among others), reimagines global aid as a space to place bets that governments or markets might see as too risky.

Localisation, a movement [started in humanitarian response](https://charter4change.org/), has broadened to advocate for more funding to organisations based in the same countries as end users.

Impact investment, pioneered by organisations like [Acumen](https://acumen.org/), is applying the VC playbook of taking equity ownership in high-uncertainty ideas that might generate outsized financial *and*social return.
...
Edward Tenner, in *Why Things Bite Back**29*, refers to these new problems as technology's ‘revenge effects’. In Tenner’s words:
...
Last year, EdTech Hub partnered with [EIDU](https://www.eidu.com/), a personalised learning app and startup providing literacy and numeracy exercises to 300,000+ pre-primary students in Kenya.
...
- A logbook (modelled on an attendance register) for teachers to mark which children had used the app that day
- Guidelines for teachers to make sure children rotated the Android smartphones every 5-10 minutes
- Increased messaging from local government officials on equality of usage.
...
![](/images/67978809b1b2534aeaf26e11_1737459880402.png)
...
*1. To elaborate: AirBnB turns long-term housing into short-term rentals, driving up rents and changing the face of whole neighbourhoods (so much so, that New York City has*[*‘de-facto banned’*](https://www.wired.com/story/airbnb-ban-new-york-city/)*it). Uber takes money out of public transit, increases traffic congestion, and routes money out of local communities. AirBnB, and Uber is banned in.*

*2. A huge shout out to*[*Josh*](https://www.linkedin.com/in/josh-whale?miniProfileUrn=urn%3Ali%3Afs_miniProfile%3AACoAAAOW9EMBIF263gaKHnHzwkN7syFGQ7H0rA8&lipi=urn%3Ali%3Apage%3Ad_flagship3_search_srp_all%3BRRThwAqHS4mGBrme9ZTS1w%3D%3D)*and*[*Alp*](https://www.linkedin.com/in/atilev?miniProfileUrn=urn%3Ali%3Afs_miniProfile%3AACoAAAC3dAoBBUdQf42CmJQj5Bu6AVqGwaCnKcs&lipi=urn%3Ali%3Apage%3Ad_flagship3_search_srp_all%3BTMy1Rs9ZRmmcWWMuz6GwgA%3D%3D)*, Ampersand’s co-Founders. At the end of last year, they raised a $19.5m Series B round.*
...
*5. The Stanford Encyclopedia of Philosophy has*[*a great summary of the ‘capability approach*](https://plato.stanford.edu/entries/capability-approach/)*’.*
...
*9. A huge shout out to*[*Nell*](https://www.linkedin.com/in/nelllemaistre/)*,*[*Leslie*](https://www.linkedin.com/in/leslie-labruto/)*,*[*Nickil*](https://www.linkedin.com/in/nickil-chopraa-151a2b133/)*, and the current 100x Impact team, who keep taking that accelerator from strength to strength 💪*

*10. Read more about Marie Stopes International’s social franchising model*[*in this report.*](https://shopsplusproject.org/sites/default/files/resources/3938_file_MSI_Franchising_Full_Report_English.pdf)

*11. Data from*[*Khan Academy’s annual report*](https://s3.amazonaws.com/KA-share/annualreport/SY22-23+Annual+Report_Final.pdf)*(2022-23).*

*12. Read more about the fascinating history of the ‘designated driver’ campaign*[*in this case study*](https://www.hsph.harvard.edu/chc/harvard-alcohol-project/)*produced by the Harvard School of Public Health.*

13. Data from [World Bank Group.](https://www.worldbank.org/en/news/press-release/2017/05/04/world-bank-approves-200-million-for-rural-roads-in-zambia)
...
15. None of this work would have been possible without [Caspar](https://www.linkedin.com/in/caspargroeneveld/), [Tom](https://www.linkedin.com/in/tom-kaye-4902054/), and [Daniel](https://www.linkedin.com/in/danielplaut/) on the EdTech Hub, and [Raya](https://www.linkedin.com/search/results/all/?fetchDeterministicClustersOnly=true&heroEntityKey=urn%3Ali%3Afsd_profile%3AACoAAAaWQXcBHJekV2Qja9scSRnX6JQxeBrjP-I&keywords=raya%20ahmada&origin=RICH_QUERY_SUGGESTION&position=0&searchId=8c9a61b9-73ef-4cb2-9e5b-2df3fff586c6&spellCorrectionEnabled=false) from [Cube Zanzibar](https://cubezanzibar.org/) Cube (Zanzibar’s first innovation hub) who collaborated with us for the project. Director Khalid, Abdalla, Masoud, Khamis, Hussein, and Mfaume were champions of this work within the Government of Zanzibar, alongside Tanya and Kaboko from the World Bank.

16. From EdTech Hub’s [virtual learning environment feasibility study in Zanzibar](https://docs.edtechhub.org/lib/K7JDL4IL/download/8TS37JIG/Groeneveld%20et%20al.%20-%202020%20-%20Deploying%20an%20e-Learning%20Environment%20in%20Zanzibar%20F.pdf) (2020).

17. This cycle of getting evidence, applying it to an idea, testing the idea, and iterating it is at the core of EdTech Hub’s [Sandbox method](https://edtechhub.org/sandboxes/the-sandbox-method/), which I developed alongside [Lea](https://www.linkedin.com/in/leasimpson/), [Alice](https://www.linkedin.com/in/alice-carter-0923737a/) and many others at EdTech Hub.

18. A note on Ampersand’s experiment: this type of experiment is called a “fake door”. It was popularised by Dropbox, who made a 4-min explainer video and asked users to join a waitlist, before they had developed their product. The waitlist was a “fake door” because there was no product behind it (yet), but it validated demand. [Here’s the original video.](https://www.youtube.com/watch?v=qxFLfY7_Gqw&ab_channel=GordonYu)

19. A note on Koalaa’s experiment: A lot of experiments I run are inspired by [*The Mom Test*by Rob Fitzpatrick](https://manuelohan.com/wp-content/uploads/2017/05/The-Mom-Test-en.pdf). In a nutshell, it encourages startups to be wary of compliments and seek meaningful commitment from users in the form of time, money or reputation. In this example, Koalaa were seeking commitment in the form of referrals, rather than meaningless assurances of working together.

20. Data from [*Adolescents’ narratives of coping with unintended pregnancy in Nairobi’s informal settlements*](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7595410/) (Numah et al, 2015).

21. [Zahid](https://www.linkedin.com/in/zahid-mitha-8b76b121/?originalSubdomain=ke) from [Novek](https://www.novek.io/) (a local internet of things startup), and [Wycliffe](https://www.linkedin.com/in/wycliffewaweru/) & [Christine](https://www.linkedin.com/in/christine-oduor-972b3652/) from [Population Services Kenya](https://www.pskenya.org/) (one of Kenya’s largest health NGOs) came together to build and test the idea.

22. Data from [*Follow On in Venture Capital*](https://www.goingvc.com/post/follow-on-in-venture-capital)(M. Palank & A. Srivastava, Going VC, 2021).

23. [*The power of catalytic philanthropy*](https://www.gatesnotes.com/The-Power-of-Catalytic-Philanthropy) (B. Gates, 2012)

24. This metric would have remained an aspiration only, without UNICEF’s pioneering [Drone and Data Academy](https://www.unicef.org/innovation/AfricanDroneAcademy) in Malawi.

25. Data from the [World Bank Group.](https://data.worldbank.org/indicator/SH.STA.MMRT?locations=KE&name_desc=true)

26. Data from the [Africa Venture Capital Association (AVCA).](https://www.avca.africa/media/o5makqy5/avca234-19-vc-report_4.pdf)

27. Data from the [Organisation for Economic Development & Cooperation (OECD).](https://www.oecd.org/en/about/news/press-releases/2024/04/international-aid-rises-in-2023-with-increased-support-to-ukraine-and-humanitarian-needs.html)

28. See also: more innovative ‘super shoes’ for running also increase injury risk, according to [one study from 2023](https://bjsm.bmj.com/content/57/23/1472).

29. [Published by Tenner in 1997](https://en.wikipedia.org/wiki/Why_Things_Bite_Back#CITEREFTenner1997), but more relevant than ever today.

30. Africa Power Storage was founded by Mike Rosenberg, a true tinkerer and innovator I had the pleasure of collaborating with. I wrote about my time in Zimbabwe, alongside Mike and his partners [here](https://medium.com/frontier-technologies-hub/notes-from-the-field-zimbabwe-a8a557ef65b1).
