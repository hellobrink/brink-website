...
- an ecosystem is genuinely early-stage
- founders have not previously accessed structured venture support
- peer learning and cohort energy add real value
- there are clear pathways after the programme
...
At Brink we’ve been thinking a lot about how funding itself needs to evolve. You can read this great blog from my colleague Lea about the [psychology of next-century grantmaking](https://www.hellobrink.co/post/the-psychology-of-next-century-grantmaking). That shift also changes how programmes are designed: support should be proportionate to the size of the grant and the capacity of the recipient, avoiding one-size-fits-all administrative burdens while still maintaining fiduciary rigour.
...
We’ve developed a [Fund Builder Tool](https://fundbuilder.hellobrink.co/) to help funders and ecosystem builders think more deliberately about how they support innovation.

This is our attempt to codify how we design adaptive, ecosystem aware support models. It encourages us to ask:

- What kind of support does this ecosystem actually need right now?
- When does capital need to be patient vs catalytic?
- When is technical assistance best embedded vs cohort-based?
- When is demand-side work more impactful than supply-side venture support?
- When is advocacy in support of policy reform a better investment than another startup programme?
