...
However, to bring these stories to life**,**I’ve learned that you can go beyond the text and into the wonderful world of creating tangible things **from** the future to share today.

## Creating “stuff” from the future

Hold this: it’s 2030, and the Arctic ice has melted. What could that mean for our world? Designer Viraj Joshi [explored this provocative question](https://www.virajvjoshi.com/postcards-from-the-future) by imagining a train ticket from Alaska to Russia, made possible by a newly navigable route across the Arctic. The train ticket was a “thing” from the future, in this case quite similar to what we see in the UK today, but from a moment in time that’s very different.

![](/images/68763c48e19e095ad15b52c4_ad_4nxcyf01o6tsaa-bakibcj86x-ini90kyqfq9ferqxwdp0waed1v.png)

In my own work with the [Frontier Tech Hub](https://www.frontiertechhub.org/), we recently created the [*Fieldtrip to the Future*](https://www.frontiertechhub.org/fttf-ai-and-diplomacy) concept to help UK FCDO staff understand the possible implications of fast-paced technology change for their work.
...
During the Fieldtrip, in one breakout room we had staff explore a [“Human Rights” scenario](https://www.frontiertechhub.org/human-rights-scenario), where in the year 2034 an AI agent called **Diplobot** is supporting the drafting of diplomatic resolutions and is trained to be hyper-ethical (with some interesting implications!).

We used ChatGPT to develop Diplobot’s backstory, then built it using [Character.AI](http://character.ai), an AI platform that lets you talk to custom virtual characters.

![](/images/68763c48e19e095ad15b52d0_ad_4nxcfwxjdzw_lbexwr2k-orp8xrpb7xdz1nz9od538xavoeyljov.png)
...
With the trends, we used OpenAI models to articulate underlying drivers and their binary extremes to develop [*axes of uncertainty*](https://medium.com/swlh/how-futurists-cope-with-uncertainty-a4fbdff4b8c6), a common way of developing future scenarios. We then used generative AI tools to rapidly flesh out these scenarios and bring to the surface some of the key tensions and implications each of them contained.
...
[I’d love to hear from others](mailto:dave@hellobrink.co) exploring the same topics. Are you using generative tools in your strategic thinking, and what are you learning from it?
