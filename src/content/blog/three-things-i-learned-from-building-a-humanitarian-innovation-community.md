...
heroAlt: Three things I learned from building a humanitarian innovation community
bannerImage: "/images/66d9d486e7c57136f38065d9_screenshot-2023-10-26-at-15.webp"
bannerAlt: Three things I learned from building a humanitarian innovation community
summary: What’s the first thing that comes to mind if I ask you what innovators need to test and scale their ideas?
sortOrder: 47
---
...
As a Community Manager that’s been working with [Humanitarian Grand Challenge: Creating Hope in Conflict](https://humanitariangrandchallenge.org/?ref=hellobrink.co) (CHIC) for the past three years, when I ask myself this question, I immediately think of people like Suzana and Sash.
...
Sash is the co-founder of [Surgibox](https://www.surgibox.com/?ref=hellobrink.co); an organisation which has created an ultraportable, sterile operating field that fits in a backpack: the [SurgiField](https://humanitariangrandchallenge.org/innovator/surgibox/?ref=hellobrink.co). It’s a very novel innovation, so in order to pass usability tests the device needed to be used and validated by 30 surgeons and, as Sash says, “Finding 30 surgeons is quite a task!”
...
**Some of the ways we’ve achieved this at CHIC:** 💡 Enabled in-person connections between innovators. Innovators often refer to these experience and resulting partnerships as pivotal moments of the programme. 💡 Created opportunities for innovators to use the community to facilitate sessions that meet their own needs. When innovators noticed that conversations about working in certain geographies often included people not residing or working there, demand arose for specific geographical sessions. So, Musab Alsayd of [WATAN](https://www.watan.org.uk/?ref=hellobrink.co) facilitated sessions for the humanitarian innovation ecosystem in Gaziantep, Turkey, and Humam Dawood of [the White Helmets](https://www.whitehelmets.org/en/?ref=hellobrink.co) ran a session in Sarmada, Syria, enabling frontline workers to directly engage with each others' innovation and discuss an ecosystem approach.
...
**Some of the ways we’ve achieved this at CHIC**: 💡 Shared insights from innovator events both through the innovator community and more broadly, including [through the CHIC blog](https://humanitariangrandchallenge.org/if-you-dont-localize-it-it-may-not-succeed-innovating-for-faster-cheaper-and-more-efficient-aid/?ref=hellobrink.co). 💡 Introduced a human element to the CHIC portfolio through the ["meet the innovator" series](https://humanitariangrandchallenge.org/blog/?page=1&per_page=50&categories=215&ref=hellobrink.co). 💡 Modelled community collaboration to the innovators through sharing real world stories, as outlined via our community newsletters.
...
If you are reading this and are seeing elements that resonate, things you want to try, or have ideas to add, I'd love to hear from you. [Connect with me on LinkedIn](https://www.linkedin.com/in/bryony-gn?ref=hellobrink.co).
