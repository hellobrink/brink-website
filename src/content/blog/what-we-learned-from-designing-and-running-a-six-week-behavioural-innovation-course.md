...
heroAlt: What we learned from designing and running a six-week Behavioural Innovation course
bannerImage: "/images/66d9dbeaee432560e0d6a552_iloicloayjd2ppaxgfws-1-1.webp"
bannerAlt: What we learned from designing and running a six-week Behavioural Innovation course
summary: "At Brink our mission has always been to make an outsized impact. We set out to do this through our approach, which we call Behavioural Innovation. We have been practising Behavioural Innovation ourselves and instilling it in the organisations and teams we have been lucky to work "
sortOrder: 26
---

At Brink our mission has always been to make an outsized impact. We set out to do this through our approach, which we call [Behavioural Innovation](https://bi.hellobrink.co/?ref=hellobrink.co). We have been practising Behavioural Innovation ourselves and instilling it in the organisations and teams we have been lucky to work with. But over time we realised we were missing a trick. To scale our impact even further we could be sharing and teaching Behavioural Innovation to other practitioners like us. This could be our route to even greater impact.
...
## Testing the waters with some early messaging
...
## Choosing Innovation Missions because the world needs these methods at scale

An innovation mission is a bold, clear, and impactful vision of a better future that drives forward thinking and strategic action within organisations and across societies. The concept of Mission Oriented Innovation [dates back to the 1960s](https://stip.oecd.org/moip/the-definition-of-moips/old-concept?ref=hellobrink.co) and has since been popularised especially by Mariana Mazzucatto through her work [and writing](https://marianamazzucato.com/books/mission-economy/?ref=hellobrink.co). At Brink we have been [working on innovation missions sparked](https://www.makingbetterfutures.org/?ref=hellobrink.co) by the challenges posed by the pandemic. We realised we had learned much along the way from the successes and many mistakes we have made and wanted others to benefit from that knowledge. We chose innovation missions as the focus for our first BrinkU course because missions are about more than just creating ideas; they are about creating tangible change and addressing complex challenges with creativity and strategic foresight. And it’s what the world needs now, if we are to tackle the polycrises of our time.

## Designing a structure that allowed for applied learning and different styles, all online

![](/images/66d9dbf6ae83282577f3b620_screenshot-2024-08-20-at-100351.png)
...
## **Use of Experience-Based Learning** (aka ‘**Don’t tell me you’re funny, tell me a joke’)**
...
One of the best known techniques within this field is [Kolb’s Experiential Learning Theory](https://experientiallearninginstitute.org/what-is-experiential-learning/?ref=hellobrink.co) which posits that people learn better by following a cycle of learning styles from concrete experience to reflection, conceptualisation and application.

> **"When a concrete experience is enriched by reflection, given meaning by thinking, and transformed by action, the new experience created becomes richer, broader, and deeper."** -[David A Kolb](https://experientiallearninginstitute.org/what-is-experiential-learning/?ref=hellobrink.co)
...
- In the first sessions, we focused exclusively on laying the foundations of psychological safety, for example by using techniques like [questions to fall in love with your team (ie questions of increasing intimacy for people to get to know each other)](https://hellobrink.co/36-questions-to-fall-in-love-with-your-team/); framing experimentation as part of the work; requesting, praising and clearly acting on feedback; and doubling down on acting with consistency.
- We gradually introduced situations that tested the cohort’s developing psychological safety, such as moving from private 1:1 discussion to 1:many feedback.
- Next, we lifted the lid on the experience. We gave learners time to reflect on how they had experienced the increasing levels of challenge, and supported them to conceptualise the theory of psychological safety.
- Finally, we invited experimentation by introducing concepts such as using the body as a research tool (ie what data are sensations in your body giving you when facilitating a group of people to do hard things), or sensing and naming the’ third entity’ in the room (ie the relationship between people and how it feels at any given moment). This meant that participants were able to further explore their own experience-based concept of psych safety.
...
## Walking the walk when it comes to innovating and adapting
...
- Using fictional and at times whimsical scenarios based on real case studies, in order to introduce key concepts playfully before layering on real-world complexity
- Using video interviews with collaborators and stakeholders in our case studies, before inviting the same people to join the final session in order to give learners the opportunity to ask deeper questions and, in essence, making our case studies interactive
- Structuring case studies as developing journeys and asking learners to conceptualise principles and applying them to their own work as we went.
...
## Splitting 15 hours of learning over six weeks

Our hypotheses that led to the structure of the course were:

- A weekly spacing over six weeks will give learners time to apply what they learn to their real-world, real-work challenges.
- 2.5h weekly live session time is the upper end of the attention envelope we’d want to push.
- 1h of weekly recap time via course materials is feasible for learners.
...
- Cultural shorthand can be a barrier. Like any group of people working on complex problems over a period of time, at Brink we have our own terminology and references which make it easier to communicate and navigate the work efficiently. But all of that shorthand needs to be translated into more universal language for a course, and it’s not a trivial task. For our next course, we’ll factor in the need for a pre-beta-test with friends of Brink!
- Check your baseline. As we learned, mission-driven innovation has appeal and applicability to a wide range of sectors. Any organisation which codifies its knowledge and tools will primarily do so for people who have a high level of specific experience - but that means that this knowledge and these tools will not make for an easily accessible learning experience. While we baselined the assumed level of familiarity with basic concepts well enough to ensure our learners had a good course experience, we’ll double down on clarifying ‘course requirements’ for the next iteration.
- Cut content, not experience. This was by far the hardest learning for us - just because we think something is ‘important’ or effective (and thus, mandatory part of internal knowledge transfer) doesn’t mean that it needs to be in the course. Bear in mind that when used internally, people will have more time in a single week to dig into case studies, go hands-on with toolkits and ask questions of experienced co-workers than a cohort has over the course of a 15-hour learning experience. We learned that the one thing to protect is the white space for learners to experience, theorise, conceptualise and experiment - everything else is fair game for the cut.

## Join us for the next Innovations Missions course in November

Are you ready to embark on your own innovation mission? Keen to take part in the next course?

[Sign up here](https://www.tickettailor.com/events/hellobrink/1268145?ref=hellobrink.co) to join a community of forward-thinkers and change-makers dedicated to making a meaningful impact.
