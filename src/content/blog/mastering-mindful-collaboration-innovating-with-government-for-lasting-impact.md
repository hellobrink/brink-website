...
bannerAlt: "Mastering Mindful Collaboration: Innovating with Government for Lasting Impact"
summary: "> Working with governments requires a different approach from engaging with startups or NGOs. Government priorities, timelines, and communication styles vary significantly, and successful collaboration depends on deep listening, cultural intelligence, and trust-building. Don't fo"
sortOrder: 20
---

> Working with governments requires a different approach from engaging with startups or NGOs. Government priorities, timelines, and communication styles vary significantly, and successful collaboration depends on deep listening, cultural intelligence, and trust-building. Don't forget patience, lots of patience. Bureaucracies can move slowly.

At Brink, we’ve spent years working alongside governments to create innovative solutions that are embedded in real-world contexts and designed for long-term impact. And in my role as Kenya Country Lead on the [EdTech Hub](https://edtechhub.org/where-we-work/kenya/) I have worked with the government of Kenya, and supported my colleagues working with governments in other countries, to use the evidence we generate to support meaningful integration of technology into classrooms for both teaching and learning, guided by different contextual realities. Along the way, we’ve learned a few things that make collaboration more effective—and it’s very much a work in progress.
...
## Five Key Principles for Effective Collaboration with Government
...
- **Make genuine connections** – Build authentic relationships based on trust and mutual respect. Take time to understand each individual and what drives them. We have found looking beneath the system to the individuals that make up the system to be really helpful in building our understanding and developing trust.
- **Be generous with your time** – Trust takes time to develop. Invest in relationships through consistent engagement, reliability, and patience.
- **Embrace flexibility** – Be adaptable. Different contexts require different approaches, and cultural nuances matter.
...
- **What’s really needed?**Where is the country at, where is the government at in their election cycle and strategy, and therefore what’s needed
- **What’s the culture?**And who/what is shaping it? For governments, I have discovered that culture is shaped by the leaders, and the intersection of the work and the politics of the day
- **How do you enable that culture to shift?**How do you build trust and work within the comfort zones of the system to support them to slowly make shifts?
- **Staying relevant and informed.** While the bureaucracy moves slowly, changes and positions can shift rapidly. How do you keep one ear on the corridors of government?
- **Putting people and relationships at the centre.**The government is made up of people, and from my experience, many of these people are working hard everyday to make a difference even when confined by the system. It is critical to always remember that not everyone in government is the same, and oftentimes politics taints the hard work that happens on government corridors.
...
- Have you mapped out the government’s current focus areas to see where your work fits in?
- Ask: “What pressures and constraints might they be facing right now?”
- How can you align meetings and proposals with key government objectives?
...
- Have you identified what value you bring to the government beyond your primary engagement?
- How can you ensure your interactions aren’t just about asking for something but also offering something useful?
- Could you develop a simple “Partner Value Bank” to track insights, connections, or resources that might benefit your government partners?
...
- When engaging with government partners, do you find yourself listening just to respond, or are you actively seeking to understand their pressures and context?
...
- How well do you understand the unwritten rules of engagement in the government culture you’re working with?
- Are there small adjustments you could make—like adapting your communication style—to build more trust?
- Could you put in place a simple system—like a briefing document or a designated culture point person—to ensure you’re always operating with cultural sensitivity?
- Who in your network could help you get a deeper read on the cultural nuances at play?
...
- Have you had the chance to see how your government partners actually work on a day-to-day basis?
- What assumptions might you be making about how decisions get made—and how could you test them?
- Is there an opportunity to spend more time alongside government teams to gain deeper insights on the technicalities of the work?
...
- How do you currently factor in flexibility when working with government partners?
- Could you experiment with allocating a small portion of time or budget for iteration and course correction?
- What would it take to embed adaptability as a recognised part of the process rather than an afterthought?
- What real barriers to working adaptively are colleagues inside government facing across budget planning, procurement or performance reviews and how might those be overcome?
...
- Where do your government partners currently go to test and develop new ideas?
- Could you create or facilitate a space that allows for more experimentation?
- What’s one small shift you could make to help lower the risk of trying something new?
...
- What’s your current approach to preparing for uncertainty in government partnerships?
- Have you mapped out potential “what if” scenarios and how you’d respond?
- Could you run a simple pre-mortem exercise to identify potential blockers before they arise?

**An example from our work:**

![](/images/67c04d6827e733604a27123c_screenshot-2025-02-27-at-113219.png)

Brink's pre-mortem tool
...
- How do you currently capture and share knowledge across your team?
- Do you have a system in place to ensure you’re staying informed about government priorities and decisions?
- What small change could you make to improve knowledge-sharing within your organisation?
...
- How do you ensure you’re not just reacting to news, but proactively gathering useful information?
- Are there key sources you could be monitoring more regularly?
- Could you experiment with a weekly or monthly insight-sharing habit to add value to your government relationships?
...
- Are there lessons from other sectors that could strengthen your government work?
- How often do you bring in external perspectives to challenge assumptions?
- What’s one small way you could start integrating cross-sector insights into your engagements?
...
- Do you have a clear map of the key decision-makers, influencers, and connectors in your government ecosystem?
- Are there hidden power dynamics that you need to take into account?
- What’s one action you could take to strengthen your understanding of how decisions get made?
...
- How do you currently track and manage your relationships with government partners?
- Are you balancing trust-based, strategic, and operational relationships effectively?
- What’s one thing you could do to be more intentional about nurturing key connections?
...
- Do I have diverse perspectives in my network, or is it too homogenous?
- How often am I meaningfully engaging with key contacts?
- Am I offering value as much as I’m receiving it?
...
- How strong and diverse is your current network?
...
Let’s build a shared understanding of what it takes to innovate effectively within government systems. Drop me an email and let’s continue the discussion. I’m at [ciku@hellobrink.co](mailto:ciku@hellobrink.co)

*A very special thanks to*[*Jennifer Otieno*](https://www.linkedin.com/in/jennifercotterotieno/?original_referer=https%3A%2F%2Fwww%2Egoogle%2Ecom%2F&originalSubdomain=ke)*, who I have the privilege of doing so much of this work with on EdTech Hub! And to*[*Abi Freeman*](https://www.linkedin.com/in/abigailfreeman/)*,*[*Miranda Dixon*](https://www.linkedin.com/in/miranda-dixon-4b718ba4/)*and*[*Rob Hinchcliffe*](https://www.linkedin.com/in/robhinchcliffe/)*who have poured their time and wisdom into helping me write this up.*
